...
public partial class Admin_login : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from registrationfrom where email =@email and Password=@password", con);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "insert into Admin_login_details(name,password,ipaddress,datetime) values('" + TextBox1.Text + "','" + this.Encrypt(TextBox2.Text.Trim()) + "','" + myIP + "','" + datetime + "')";
            cmd.ExecuteNonQuery();
            con.Close();
