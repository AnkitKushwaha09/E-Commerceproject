<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin-login.aspx.cs" Inherits="Admin_login" EnableEventValidation="False" %>
										  ...
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form action="https://w3crm.dexignzone.com/xhtml/index.html" class=" dz-form pb-3">
													...
													<div class="form-group mb-3">
                                                        <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Email Address" TextMode="Email"></asp:TextBox>
													</div>
													<div class="form-group mb-3">
												...
												<div class="text-center bottom"> 
                                                    <a href="Admin-login-panel.aspx" class="btn btn-primary button-md btn-block" >Create an account</a>
												</div>
										  </div></div>
										</div>
									</nav>
