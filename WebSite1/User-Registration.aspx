<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User-Registration.aspx.cs" Inherits="User_Registration" EnableEventValidation="False" %>
                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="https://w3crm.dexignzone.com/xhtml/index.html">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Phone Number"  TextMode="Phone"></asp:TextBox>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Already have an account? <a class="text-primary" href="User-login.aspx">Sign in</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
