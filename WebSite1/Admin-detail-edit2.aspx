<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Admin-detail-edit2.aspx.cs" Inherits="Admin_detail_edit2" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="mb-3">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-10">
                                                <asp:Button ID="Button2" class="btn btn-primary" runat="server" Text="UPDATE" Width="126px" OnClick="Button2_Click" />
                                            </div>
                                        </div>
